...
log = logging.getLogger("cricstar.core.metrics")

caught_balls = Counter("caught_cb", "Caught cricketers", ["country", "special", "guild_size", "spawn_algo"])
...
class PrometheusServer:
    ...
    def __init__(self, bot: "CricStarBot", host: str = "localhost", port: int = 15260):
        self.bot = bot
        self.host = host
        self.port = port
