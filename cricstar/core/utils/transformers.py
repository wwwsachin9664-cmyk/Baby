...
class ModelTransformer[T: "Model"](app_commands.Transformer, commands.Converter):
    ...
    **filters: Any
    ...
    async def validate(self, ctx: commands.Context["CricStarBot"], item: T):
        """
    ...
    async def get_options(
        self, interaction: discord.Interaction["CricStarBot"], value: str
    ...
    async def transform(self, interaction: discord.Interaction["CricStarBot"], value: str) -> T:
        if not value:
    ...
    async def convert(self, ctx: commands.Context["CricStarBot"], argument: str) -> T:
        try:
...
class BallInstanceTransformer(ModelTransformer[BallInstance]):
    ...
    async def validate(self, ctx: commands.Context["CricStarBot"], item: BallInstance):
