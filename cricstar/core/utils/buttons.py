...
class ConfirmChoiceView(View):
    ...
    Parameters
    ----------
    ctx: Interaction[CricStarBot] | commands.Context[CricStarBot]
    ...
    def __init__(
        self,
        ctx: discord.Interaction["CricStarBot"] | commands.Context["CricStarBot"],
        ...
        self.interaction_response: discord.Interaction["CricStarBot"]
    ...
    async def confirm_button(self, interaction: discord.Interaction["CricStarBot"], button: Button):
        for item in self.children:
            item.disabled = True  # type: ignore
    ...
    async def cancel_button(self, interaction: discord.Interaction["CricStarBot"], button: Button):
        for item in self.children:
            item.disabled = True  # type: ignore
