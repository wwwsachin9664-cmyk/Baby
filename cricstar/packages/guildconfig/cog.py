...
class Config(commands.GroupCog):
    ...
    async def channel(
        ...
        """
        Set or change the channel where cricketers will spawn.
    ...
    async def disable(self, interaction: discord.Interaction["CricStarBot"]):
        """
        Disable or enable cricketers spawning.
        """
    ...
    @app_commands.command()
    @app_commands.checks.has_permissions(manage_guild=True)
    async def status(self, interaction: discord.Interaction["CricStarBot"]):
        """
