...
from cricstar.packages.cricketers.spawn import BaseSpawnManager
...
# It is a good idea to call importlib.reload on your custom module to make "b.reload cricketers"
