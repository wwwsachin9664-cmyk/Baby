...
class BallAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        (
            "Ability",
            {"description": "The ability of the cricketer", "fields": ["capacity_name", "capacity_description"]},
        ),
        (
            "Advanced",
            {
    ...
    search_help_text = "Search for cricketer name, ID, ability name/content, credits, catch names or translations"
