...
def default_models_forward(apps: "Apps", schema_editor: "BaseDatabaseSchemaEditor"):
    ...
    object, created = Special.objects.get_or_create(
        ...
        defaults={
            ...
            "catch_phrase": "**✨ It's a shiny cricketer! ✨**",
            "emoji": "✨",
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("enabled", models.BooleanField(help_text="Whether the bot will spawn cricketers in this guild")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("capacity_name", models.CharField(help_text="Name of the cricketer's capacity", max_length=64)),
                (
                    "capacity_description",
                    models.CharField(help_text="Description of the cricketer's capacity", max_length=256),
                ),
