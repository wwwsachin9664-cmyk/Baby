    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "collectible_name",
                    models.TextField(default="cricketer", help_text="The singular name of your collectible"),
                ),
                (
                    "plural_collectible_name",
                    models.TextField(default="cricketers", help_text="The plural name of your collectible"),
                ),
                ("bot_name", models.TextField(default="CricStar", help_text="The name of your bot")),
                (
                    "cricstar_slash_name",
                    models.TextField(
                        default="cricstar",
