...
# Python 3.12 compatibility: warnings.deprecated was added in 3.13
...
class Settings(models.Model):
    ...
    collectible_name = models.TextField(help_text="The singular name of your collectible", default="cricketer")
    plural_collectible_name = models.TextField(help_text="The plural name of your collectible", default="cricketers")
    bot_name = models.TextField(help_text="The name of your bot", default="CricStar")
    cricstar_slash_name = models.TextField(
    ...
    spawn_manager = models.TextField(
        ...
        default="cricstar.packages.cricketers.spawn.SpawnManager",
    ...
    about_description = models.TextField(
        ...
        default="Collect cricketers on Discord, exchange them and battle with friends!",
    )
    repository = models.URLField(
        help_text="URL to the repository with the source code.",
        default="https://github.com/Ballsdex-Team/CricStar-DiscordBot",
    )
